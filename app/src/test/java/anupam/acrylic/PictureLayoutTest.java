...
public class PictureLayoutTest {
	@Before
	...
	@Test
	public void addView2( ) throws Exception {
		//Just creating some dummy tests for now. They will always fail. Replace this with a real test:
		assertFalse( "Test not implemented", true );
	}
	
	@Test
	public void addView3( ) throws Exception {
		//Just creating some dummy tests for now. They will always fail. Replace this with a real test:
		assertFalse( "Test not implemented", true );
	}
	
	@Test
	public void generateDefaultLayoutParams( ) throws Exception {
		//Just creating some dummy tests for now. They will always fail. Replace this with a real test:
		assertFalse( "Test not implemented", true );
	}
	...
	@Test
	public void dispatchDraw( ) throws Exception {
		//Just creating some dummy tests for now. They will always fail. Replace this with a real test:
		assertFalse( "Test not implemented", true );
	}
	
	@Test
	public void invalidateChildInParent( ) throws Exception {
		//Just creating some dummy tests for now. They will always fail. Replace this with a real test:
		assertFalse( "Test not implemented", true );
	}
